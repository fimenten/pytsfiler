...
from __init__ import (
    get_jwt_token, register_user, upload_file, upload_binary, 
    decode2binary, upload_file_direct, upload_binary_direct
)
...
def test_file_upload(token, config):
    ...
    try:
        ...
        print(f"✗ File already exists on server - this is expected behavior")
        return None, None
    except Exception as e:
